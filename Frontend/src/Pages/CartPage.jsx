...
export default function CartPage() {
  ...
  if (!userId) return <div className="text-center mt-10">Please login to view your cart.</div>;

  return (
    <>
    <Navbar />
    <div className="w-[90%] max-w-[900px] mx-auto my-10 bg-white p-6 rounded-lg">
