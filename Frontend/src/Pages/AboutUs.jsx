...
const AboutUs = () => {
  ...
  return (
    <div className="relative overflow-x-hidden text-gray-800 bg-white font-[Poppins]">
      ...
      <div id="galaxy" className="fixed top-0 left-0 w-full h-full -z-10 overflow-hidden pointer-events-none"></div>

      <Navbar />

      {/* Hero Section */}
      <section className="text-center py-32 px-5 bg-gradient-to-br from-blue-100 to-blue-200 relative">
        <h1 className="text-5xl font-bold text-blue-800 drop-shadow-md">Welcome to Zarvoc</h1>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto mt-6">Your Ultimate Online Shopping Experience</p>
        <a
          href="/"
      ...
      <section className="max-w-7xl mx-auto px-5 py-20 mt-[-50px] relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center bg-white/50 p-8 rounded-xl shadow-xl backdrop-blur border border-blue-100">
          <div>
            <h2 className="text-2xl font-bold text-blue-700 mb-4">Cosmic Shopping Redefined</h2>
            <p className="text-gray-700 mb-4">
              At Zarvoc, we've transformed online shopping into a stellar experience. We're not just another e-commerce platform;
              we're your intergalactic marketplace where convenience meets the stars.
            </p>
            <p className="text-gray-700">
              Our mission is to revolutionize e-commerce by combining stellar customer service with competitive prices,
              lightning-fast delivery, and an unforgettable user experience.
            </p>
          </div>
          <div>
            <img
      ...
      <section className="max-w-7xl mx-auto px-5 py-20">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-semibold text-blue-700">Why Choose Zarvoc?</h2>
          <div className="h-1 w-20 mx-auto mt-4 bg-blue-400 rounded"></div>
        </div>
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            >
              ...
              <h3 className="text-xl text-blue-800 font-semibold mb-2">{title}</h3>
      ...
      <section className="max-w-7xl mx-auto px-5 py-20">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-semibold text-blue-700">Meet Our Team</h2>
          <div className="h-1 w-20 mx-auto mt-4 bg-blue-400 rounded"></div>
        </div>
      ...
      <section className="text-center py-24 px-5 bg-blue-50">
        <h2 className="text-3xl font-semibold text-blue-800 mb-6">Ready for a Cosmic Shopping Experience?</h2>
        <button
          onClick={() => navigate('/')}
